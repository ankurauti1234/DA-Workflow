...
file1_csv = BASE_DIR / "sessions" / "logo" / "household_viewership_memberwise_output" / "logo_sessions.csv"   # primary file
file2_csv = BASE_DIR / "sessions" / "fp" / "output" / "fp_sessions.csv"   # secondary file (rows removed if hhid exists in file1)
yesterday = (datetime.now() - timedelta(days=1)).strftime("%Y-%m-%d")
output_csv = BASE_DIR / "sessions" / "merging" / f"{yesterday}_Sessions.csv"

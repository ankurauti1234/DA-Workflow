...
CHANNEL_CSV = BASE_DIR / "sessions" / "fp" / "output" / "sessions_output.csv"     # channel-level sessions (already sessionized)
MEMBER_CSV  = BASE_DIR / "sessions" / "fp" / "output" / "merged_timeline.csv"     # type=3 member declarations
OUTPUT_CSV  = BASE_DIR / "sessions" / "fp" / "output" / "final_channel_member_sessions.csv"
